...
class MyPianoGUI:
    def __init__(self, master):
        ...
        self.C_0_button = Button(self.pianoFrame, bg="white", text="C_0", command=lambda:[note_C0(pianoFrame),record("C"),update_note_text(f'C{self.octave}')], height=10, width=6)
        self.C_0_button.grid(row=3, column=0)
        self.master.bind('<a>', lambda event: [note_C0(pianoFrame), record("C"),update_note_text(f'C{self.octave}')])


        self.D_0_button = Button(self.pianoFrame, bg="white", text="D_0", command=lambda:[note_D0(pianoFrame),record("D"),update_note_text(f'D{self.octave}')], height=10, width=6)
        self.D_0_button.grid(row=3, column=1)
        self.master.bind('<s>', lambda event:[ note_D0(pianoFrame),record("D"),update_note_text(f'D{self.octave}')])

        self.E_0_button = Button(self.pianoFrame, bg="white", text="E_0", command=lambda:[note_E0(pianoFrame),record("E"),update_note_text(f'E{self.octave}')], height=10, width=6)
        self.E_0_button.grid(row=3, column=2)
        self.master.bind('<d>', lambda event: [note_E0(pianoFrame),record("E"),update_note_text(f'E{self.octave}')])

        self.F_0_button = Button(self.pianoFrame, bg="white", text="F_0", command=lambda:[note_F0(pianoFrame),record("F"),update_note_text(f'F{self.octave}')], height=10, width=6)
        self.F_0_button.grid(row=3, column=3)
        self.master.bind('<f>', lambda event: [note_F0(pianoFrame),record("F"),update_note_text(f'F{self.octave}')])

        self.G_0_button = Button(self.pianoFrame, bg="white", text="G_0", command=lambda:[note_G0(pianoFrame),record("G"),update_note_text(f'G{self.octave}')], height=10, width=4)
        self.G_0_button.grid(row=3, column=4)
        self.master.bind('<g>', lambda event: [note_G0(pianoFrame),record("G"),update_note_text(f'G{self.octave}')])

        self.A_0_button = Button(self.pianoFrame, bg="white", text="A_0", command=lambda:[note_A0(pianoFrame),record("A"),update_note_text(f'A{self.octave}')], height=10, width=6)
        self.A_0_button.grid(row=3, column=5)
        self.master.bind('<h>', lambda event: [note_A0(pianoFrame),record("A"),update_note_text(f'A{self.octave}')])

        self.B_0_button = Button(self.pianoFrame, bg="white", text="B_0", command=lambda:[note_B0(pianoFrame),record("B"),update_note_text(f'B{self.octave}')], height=10, width=6)
        self.B_0_button.grid(row=3, column=6)
        self.master.bind('<j>', lambda event: [note_B0(pianoFrame),record("B"),update_note_text(f'B{self.octave}')])

        self.placeHolder = Label(self.pianoFrame, height=7, width=6, bg=self.frameColour)
        self.placeHolder.grid(row=1, column=6)

        self.CC_0_button = Button(self.pianoFrame, bg="black", fg="white", text="C#_0", command=lambda:[note_CC0(pianoFrame),record("C#"),update_note_text(f'C#{self.octave}')], height=10, width=3)
        #self.CC_0_button.grid(row=1, columnspan=2)
        self.CC_0_button.place(x=35, y=40)
        self.master.bind('<w>', lambda event: [note_CC0(pianoFrame),record("C#"),update_note_text(f'C#{self.octave}')])

        self.DD_0_button = Button(self.pianoFrame, bg="black", fg="white", text="D#_0", command=lambda:[note_DD0(pianoFrame),record("D#"),update_note_text(f'D#{self.octave}')], height=10, width=3)
        #self.DD_0_button.grid(row=1, columnspan=4)
        self.DD_0_button.place(x=85, y=40)
        self.master.bind('<e>', lambda event: [note_DD0(pianoFrame),record("D#"),update_note_text(f'D#{self.octave}')])

        self.AA_0_button = Button(self.pianoFrame, bg="black", fg="white", text="A#_0", command=lambda:[note_AA0(pianoFrame),record("A#"),update_note_text(f'A#{self.octave}')], height=10, width=3)
        #self.AA_0_button.grid(row=1, column=5, columnspan=2)
        self.AA_0_button.place(x=290, y=40)
        self.master.bind('<u>', lambda event: [note_AA0(pianoFrame),record("A#"),update_note_text(f'A#{self.octave}')])

        self.GG_0_button = Button(self.pianoFrame, bg="black", fg="white", text="G#_0", command=lambda:[note_GG0(pianoFrame),record("G#"),update_note_text(f'G#{self.octave}')], height=10, width=3)
        #self.GG_0_button.grid(row=1, column=4, columnspan=2)
        self.GG_0_button.place(x=240, y=40)
        self.master.bind('<y>', lambda event: [note_GG0(pianoFrame),record("G#"),update_note_text(f'G#{self.octave}')])

        self.FF_0_button = Button(self.pianoFrame, bg="black", fg="white", text="F#_0", command=lambda:[note_FF0(pianoFrame),record("F#"),update_note_text(f'F#{self.octave}')], height=10, width=3)
        #self.FF_0_button.grid(row=1, column=3, columnspan=2)
        self.FF_0_button.place(x=190, y=40)
        self.master.bind('<t>', lambda event: [note_FF0(pianoFrame),record("F#"),update_note_text(f'F#{self.octave}')])
        ...
        #                          command=lambda: [note_D0(pianoFrame), record("D"),
        ...
        #                          command=lambda: [note_E0(pianoFrame), record("E"),
        ...
        #                          command=lambda: [note_F0(pianoFrame), record("F"),
        ...
        #                          command=lambda: [note_G0(pianoFrame), record("G"),
        ...
        #                          command=lambda: [note_A0(pianoFrame), record("A"),
        ...
        #                          command=lambda: [note_B0(pianoFrame), record("B"),
