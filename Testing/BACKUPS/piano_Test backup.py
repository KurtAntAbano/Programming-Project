...
# def note_A0():
#     num1.set("A_0")
#     sound = pygame.mixer.Sound("../piano testing and files/wavs/Piano/octave1/PianoA.wav")
#     sound.play()
#
#
# def note_AA0():
...
# def note_B0():
#     num1.set("B_0")
#     sound = pygame.mixer.Sound("../piano testing and files/wavs/Piano/octave1/PianoB.wav")
#     sound.play()
#
#
# class MyPianoGUI:
