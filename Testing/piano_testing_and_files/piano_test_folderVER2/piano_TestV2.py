...
from playNoteFunctionsV2 import *
...
class MyPianoGUI:
    def __init__(self, master):
        ...
        # https://www.pythongusis.com/faq/pack-place-and-grid-in-tkinter/
        ...
        self.CC_0_button = Button(self.pianoFrame, bg="black", fg="white", text="C#_0",
                                  command=lambda: [note_CC0(pianoObj, 1), record("C#"),
        ...
        self.master.bind('<w>',
                         lambda event: [note_CC0(pianoObj, 1), record("C#"), update_note_text(f'C#{self.octave}')])

        self.DD_0_button = Button(self.pianoFrame, bg="black", fg="white", text="D#_0",
                                  command=lambda: [note_DD0(pianoObj, 1), record("D#"),
        ...
        self.master.bind('<e>',
                         lambda event: [note_DD0(pianoObj, 1), record("D#"), update_note_text(f'D#{self.octave}')])

        self.AA_0_button = Button(self.pianoFrame, bg="black", fg="white", text="A#_0",
                                  command=lambda: [note_AA0(pianoObj, 1), record("A#"),
        ...
        self.master.bind('<u>',
                         lambda event: [note_AA0(pianoObj, 1), record("A#"), update_note_text(f'A#{self.octave}')])

        self.GG_0_button = Button(self.pianoFrame, bg="black", fg="white", text="G#_0",
                                  command=lambda: [note_GG0(pianoObj, 1), record("G#"),
        ...
        self.master.bind('<y>',
                         lambda event: [note_GG0(pianoObj, 1), record("G#"), update_note_text(f'G#{self.octave}')])

        self.FF_0_button = Button(self.pianoFrame, bg="black", fg="white", text="F#_0",
                                  command=lambda: [note_FF0(pianoObj, 1), record("F#"),
        ...
        self.master.bind('<t>',
                         lambda event: [note_FF0(pianoObj, 1), record("F#"), update_note_text(f'F#{self.octave}')])
...
pianoObj = MyPianoGUI(mainWindow)
num1 = StringVar()
pygame.mixer.init()
mainWindow.mainloop()
